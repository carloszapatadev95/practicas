...
const Ordenar_mayor_menor = () => {
    ...
    let numerosB = [a, b];
    if (!a || !b) {
        console.log('los datos no son numericos');
        document.querySelector("#datos_M_m").innerHTML = 'los datos no son numericos o uno de los datos no es numerico';
    } else {
        let menor = Math.min(a, b);
        if (a > b) {
            console.log('el menor es a:', numerosA);
            document.querySelector("#datos_M_m").innerHTML = numerosA;
            document.querySelector("#Mayor_menor").innerHTML = menor;
        } else {
            console.log('el menor es b :', numerosB);
            document.querySelector("#datos_M_m").innerHTML = numerosB;
            document.querySelector("#Mayor_menor").innerHTML = menor;
